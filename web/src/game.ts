...
export function renderGame(main: HTMLElement, renderHome: () => void) {
  // 1. Render the game HTML
  main.innerHTML = `
    <div class="min-h-screen flex flex-col items-center justify-center bg-white">
      ...
      <button id="back-btn" class="mt-4 py-3 px-8 rounded-full bg-gradient-to-br from-[#ffcc00] to-[#ea9800] shadow-md hover:scale-105 transition-all text-white text-lg font-semibold">Back</button>
    </div>
  `;
...
function keyDownHandler(e: KeyboardEvent) {
  ...
  // 9. Clean-up when leaving game screen
