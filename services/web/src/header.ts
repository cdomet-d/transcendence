export function renderHeader() {
    ...
    // Créer l'élément header s'il n'existe pas
    let headerElement = document.getElementById('header');
    if (!headerElement) {
        console.warn('Element with id "header" not found, creating it...');
    ...
    headerElement.innerHTML = `
        <header class="w-full bg-amber-200 text-white px-4 py-2 flex items-center justify-between shadow">
            ...
            <div class="flex items-center space-x-3 flex-shrink-0">
                <img src="images/sunflower.svg" alt="BigT Pong Logo" class="h-10 w-10 object-contain"/>
