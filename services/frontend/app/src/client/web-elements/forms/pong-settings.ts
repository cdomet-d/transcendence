 ...
 *
 * @export
 * @class PongTournamentSettings
 * @extends {LocalPongSettings}
 * @remark customElement: `'pong-tournament-settings'`
 */
export class PongTournamentSettings extends LocalPongSettings {
    #searchbar: Searchbar;
    #guestWrapper: HTMLDivElement;
    #invitedUsers: UserData[] | null;
    // #inviteHandler: (ev: SubmitEvent) => void
...
if (!customElements.get('pong-tournament-settings')) {
    customElements.define('pong-tournament-settings', PongTournamentSettings, { extends: 'form' });
}
